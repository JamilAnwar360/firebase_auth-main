...
class report_found_item extends StatefulWidget {
  const report_found_item({Key? key}) : super(key: key);

  @override
  _ReportMissingItemState createState() => _ReportMissingItemState();
}

class _ReportMissingItemState extends State<report_found_item> {
  String _personName = '';
  String _description = '';
  File? _image;
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Please provide information about the found person:',
              style: TextStyle(
                fontSize: 18,
